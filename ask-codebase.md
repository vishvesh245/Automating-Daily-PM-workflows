...
- **Backend index (mx-instant-api):** `https://docs.google.com/document/d/1TN3Y-A6RsDeCPvvCn-hcXgwYP-ugmWkHS91GreMFHmw/export?format=txt`
- **Frontend index (bappzaar):** `https://docs.google.com/document/d/1PnH8GaCzobOvFMau9RnzxE_r44PKaReYCzeS77PuQEE/export?format=txt`
